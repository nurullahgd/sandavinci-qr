...
const menuData = {
  kahve: [
    { id: 'k4', name: 'Espresso', description: 'Yoğun espresso', price: 100, image: 'https://images.unsplash.com/photo-1610889556528-9a770e32642f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80', popular: true },
    ...
    {id:'k20',name:'Lungo Espresso',description:'Üç kat espresso',price:115,image:'https://images.unsplash.com/photo-1551030173-122aabc4489c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80'},
    ...
    { id: 'k10', name: 'Americano', description: 'Espresso ve sıcak su', price: '115₺-130₺', image: 'https://images.unsplash.com/photo-1551030173-122aabc4489c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 'k11', name: 'Caffe Latte', description: 'Espresso ve buhar püskürtülmüş süt', price: '115₺-135₺', image: 'https://images.unsplash.com/photo-1570968915860-54d5c301fa9f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 'k12', name: 'Cappuccino', description: 'Espresso, buhar püskürtülmüş süt ve süt köpüğü', price: '115₺-135₺', image: 'https://images.unsplash.com/photo-1610889556528-9a770e32642f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80', popular: true },
    { id: 'k13', name: 'Cortado', description: 'Espresso ve az miktar buhar püskürtülmüş süt', price: '115₺-135₺', image: 'https://images.unsplash.com/photo-1610889556528-9a770e32642f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 'k14', name: 'Flat White', description: 'Espresso ve kadifemsi süt', price: '115₺-135₺', image: 'https://images.unsplash.com/photo-1610889556528-9a770e32642f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 'k15', name: 'Mocha', description: 'Espresso, çikolata ve buhar püskürtülmüş süt', price: '115₺-135₺', image: 'https://images.unsplash.com/photo-1527683040093-3a2b80ed1592?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 'k16', name: 'White Mocha', description: 'Espresso, beyaz çikolata ve buhar püskürtülmüş süt', price: '115₺-135₺', image: 'https://images.unsplash.com/photo-1527683040093-3a2b80ed1592?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
  ...
  bitki: [
    { id: 'sg13', name: 'Çay', description: 'Klasik siyah çay', price: 40, image: "https://i.hizliresim.com/hcqsy17.jpg" },
    { id: 'sg14', name: 'Fincan', description: 'Fincanda Klasik siyah çay', price: 50, image: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    ...
    {id:'b6',name:'Aşk Çayı',description:'Aşk çayı',price:100,image:'https://images.unsplash.com/photo-1563911892437-1feda0179e1b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80'}
  ],
  sogukKahve: [
  ...
  sogukIcecek: [
    ...
    { id: 'sg14', name: 'Su', description: 'Doğal kaynak suyu', price: 40, image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    ...
    { id: 'sg22', name: 'Meyve Suları', description: 'Çeşitli meyve suları', price: 60, image: 'https://images.unsplash.com/photo-1589733955941-5eeaf752f6dd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
  ...
  tatli: [
    ...
    { id: 't1', name: 'Paris Ekler Porsiyon', description: 'Özel Paris Ekler', price: 250, image: 'https://images.unsplash.com/photo-1602351447937-745cb720612f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80', popular: true },

  ],
  sandvic: [
    { id: 's1', name: '🥪 Gurme Soğuk Sandviç S', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik', price: 175, image: 'https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 's2', name: '🥪 Susam Soğuk Sandviç S', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik', price: 175, image:'https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 's3', name: '🥪 Gurme Soğuk Sandviç M', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik, 15gr dana füme, 15gr hindi füme', price: 225, image:'https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80' },
    { id: 's4', name: '🥪 Susam Soğuk Sandviç M', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik, 15gr dana füme, 15gr hindi füme', price: 225, image:"https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" },
    { id: 's5', name: '🥪 Gurme Soğuk Sandviç L', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik, 15gr dana füme, 15gr hindi füme, 20gr pastırma, 20gr kavurma, 20gr kuru et, 1 tercih hakkı', price: 275 , image:"https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"},
    { id: 's6', name: '🥪 Susam Soğuk Sandviç L', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik, 15gr dana füme, 15gr hindi füme, 20gr pastırma, 20gr kavurma, 20gr kuru et, 1 tercih hakkı', price: 275, image:"https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" },
    { id: 's7', name: '🥪 Gurme Soğuk Sandviç XL', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik, 15gr dana füme, 15gr hindi füme, 20gr pastırma, 20gr kavurma, 20gr kuru et, 3 tercih hakkı', price: 325, image:"https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" },
    { id: 's8', name: '🥪 Susam Soğuk Sandviç XL', description: 'Zeytin ezmesi, labne, kaşar, cheddar, 15gr jambon, yeşillik, 15gr dana füme, 15gr hindi füme, 20gr pastırma, 20gr kavurma, 20gr kuru et, 3 tercih hakkı', price: 325 , image:"https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"},
    { id: 's9', name: 'İlave Ürün', description: 'Sandviçlere ekstra malzeme ekleyebilirsiniz', price: 20, image:"https://images.unsplash.com/photo-1553909489-cd47e0907980?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" }
  ],
  alternatifler: [
